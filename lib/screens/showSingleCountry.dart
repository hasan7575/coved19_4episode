                  ...
                  child: new Row(
                    ...
                    children: [
                      new GestureDetector(
                        child:Row(
                          children: [
                            new Text('${persianDate.gregorianToJalali("${from}T00:19:54.000Z","yyyy-m-d")}',style: new TextStyle(color: Colors.white),),
                      ...
                      new GestureDetector(
                        child:Row(
                          children: [
                            new Text('${persianDate.gregorianToJalali("${toDate}T00:19:54.000Z","yyyy-m-d")}',style: new TextStyle(color: Colors.white),),
                            new Icon(Icons.arrow_drop_down,color: Colors.white,)
                          ],
                        ),
                      ),
